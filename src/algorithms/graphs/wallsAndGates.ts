...
export const wallsAndGates: Algorithm = {
  ...
  lineExplanations: {
    ...
    javascript: {
      1: 'Define function taking rooms grid in-place',
      2: 'Return early if grid is empty',
      3: 'Get grid dimensions',
      4: 'Define INF constant for empty rooms',
      5: 'Initialize BFS queue array',
      7: 'Scan grid to find all gate cells',
      8: 'Iterate through each column',
      9: 'If cell is a gate, add to queue',
      10: 'Add gate position to BFS queue',
      12: 'Define four directional offsets',
      13: 'BFS loop until queue is empty',
      14: 'Dequeue one position',
      15: 'Try each of four directions',
      16: 'Calculate neighbor coordinates',
      17: 'Check row bounds',
      18: 'Check column bounds',
      19: 'Check if neighbor is empty room',
      20: 'Set distance = current + 1',
      21: 'Add updated room to queue',
    },
    java: {
      ...
      3: 'Get grid dimensions',
      4: 'Define INF constant for empty rooms',
      5: 'Initialize BFS queue',
      7: 'Scan grid to find all gate cells',
      8: 'Iterate through each column',
      9: 'If cell is a gate',
      10: 'Add gate position to BFS queue',
      15: 'Define four directional offsets',
      16: 'BFS loop until queue is empty',
      17: 'Dequeue one position',
      18: 'Extract row and column from position',
      19: 'Try each of four directions',
      20: 'Calculate neighbor coordinates',
      21: 'Check bounds and if neighbor is empty room',
      22: 'Set distance = current + 1',
      23: 'Add updated room to queue',
    },
  },
};
