...
private static void backtrack(int start, List<String> current, String s,
  ...
  lineExplanations: {
    ...
    javascript: {
      ...
      13: 'Define recursive backtrack helper',
      14: 'Base case: reached end of string',
      15: 'Save copy of current partition',
      16: 'Return after saving',
      19: 'Try all end positions from start onward',
      20: 'Only proceed if substring is palindrome',
      21: 'Choose: add palindrome substring',
      22: 'Recurse from position after substring',
      23: 'Unchoose: remove last substring',
      28: 'Start backtracking from index 0',
      29: 'Return all palindrome partitions',
    },
    java: {
      1: 'Define method returning list of partitions',
