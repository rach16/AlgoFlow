...
private static void backtrack(int idx, StringBuilder current, String digits, Map<Character, String> phone, List<String> result) {
  ...
  lineExplanations: {
    python: {
      ...
      13: 'Base case: processed all digits',
      14: 'Join current letters and add to result',
      15: 'Return after saving combination',
      ...
      22: 'Start backtracking from first digit',
      23: 'Return all letter combinations',
    },
    javascript: {
      1: 'Define function taking digit string',
