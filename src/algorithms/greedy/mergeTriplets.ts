...
export const mergeTriplets: Algorithm = {
  ...
  lineExplanations: {
    python: {
      ...
      2: 'Initialize set to track matched positions',
      4: 'Iterate through each triplet',
      5: 'Skip if any value exceeds target',
      6: 'Continue to next triplet',
      7: 'Check each position in the triplet',
      8: 'If value matches target at this position',
      9: 'Add position index to matched set',
      11: 'Return true if all 3 positions matched',
    },
    javascript: {
      1: 'Define function taking triplets and target',
      2: 'Initialize set to track matched positions',
      ...
      5: 'Skip if any value exceeds target',
      6: 'Continue to next triplet',
      7: 'Check each of 3 positions',
      8: 'If value matches target, add to set',
      12: 'Return true if all 3 positions matched',
    },
    java: {
      ...
      5: 'Skip if any value exceeds target',
      6: 'Continue to next triplet',
      8: 'Check each of 3 positions',
      9: 'If value matches target at this position',
      10: 'Add position index to matched set',
      15: 'Return true if all 3 positions matched',
    },
  },
};
