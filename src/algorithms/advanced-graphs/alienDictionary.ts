...
private boolean dfs(char c, Map<Character, Set<Character>> adj,
  ...
  lineExplanations: {
    ...
    javascript: {
      ...
      6: 'Compare adjacent word pairs',
      7: 'Get the two adjacent words',
      8: 'Find shorter length for comparison',
      9: 'Return "" if longer word is prefix',
      10: 'Compare characters at each position',
      11: 'Found first differing character',
      12: 'Check if edge already exists',
      13: 'Add ordering edge',
      14: 'Increment target char in-degree',
      16: 'Stop after first difference',
      21: 'Start BFS with zero in-degree characters',
      22: 'Result stores topological order',
      23: 'Process queue for topological sort',
      24: 'Dequeue next character',
      25: 'Add to result order',
      26: 'Process all neighbors',
      27: 'Decrement neighbor in-degree',
      28: 'Enqueue when in-degree becomes 0',
      31: 'Return order if complete, else empty string',
    },
    java: {
      1: 'Define method taking sorted word array',
      ...
      11: 'Compare adjacent word pairs',
      12: 'Get the two adjacent words',
      13: 'Find shorter length for comparison',
      14: 'Return "" if longer word is prefix',
      15: 'Return empty string for invalid case',
      17: 'Compare characters at each position',
      18: 'Found first differing character',
      19: 'Check if edge already exists',
      20: 'Add ordering edge',
      21: 'Increment target char in-degree',
      23: 'Stop after first difference',
      28: 'Init BFS queue with zero in-degree chars',
      29: 'Check all characters for in-degree 0',
      30: 'Add zero in-degree chars to queue',
      33: 'Result StringBuilder for topological order',
      34: 'Process queue for topological sort',
      35: 'Dequeue next character',
      36: 'Append character to result',
      37: 'Process all neighbors',
      38: 'Decrement neighbor in-degree',
      39: 'Enqueue when in-degree becomes 0',
      42: 'Return order if complete, else empty string',
    },
  },
};
