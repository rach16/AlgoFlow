    ...
    return seen.size() == n;
      ...
      lineExplanations: {
        python: {
          ...
          3: 'Define function taking the array',
          4: 'Array length',
          5: 'A single element is trivially connected',
          7: 'A 1 shares no prime with anything',
          8: 'So the answer is false',
          10: 'Sieve bound is just past the largest value',
          11: 'spf[v] starts as v itself',
          13: 'Classic sieve loop',
          14: 'p is prime if nothing smaller marked it',
          15: 'Mark multiples starting at p*p',
          16: 'Only fill in the first (smallest) prime factor',
          17: 'Record it',
          20: 'prime -> list of indices containing it',
          21: 'index -> its distinct primes',
          22: 'Factor every value',
          ...
          30: 'Start the traversal at index 0',
          31: 'DFS stack',
          32: 'Standard iterative DFS',
          33: 'Pop the next index',
          34: 'Every prime of this value...',
          35: '...connects to every other index sharing it',
          36: 'New index?',
          37: 'Mark it seen',
          38: 'And explore from it later',
