    ...
    for (int[] e : adj.getOrDefault(u, new ArrayList<>())) {
      ...
      lineExplanations: {
        python: {
          ...
          4: 'Find with path halving',
          10: 'Tarjan bridge finder over the contracted graph',
          11: 'Adjacency list keyed by DSU root',
          12: 'Only the current weight group participates',
          13: 'Contract endpoints to their component roots',
          14: 'Store neighbor plus the edge index',
          15: 'Undirected — add the reverse arc too',
          16: 'Discovery times, low-links, results, DFS clock',
          18: 'Depth-first search tracking the entry edge',
          19: 'Stamp discovery and low-link',
          20: 'Advance the clock',
          21: 'Walk every incident edge',
          22: 'Never bounce straight back along the entry edge',
          24: 'Already discovered — this is a back edge',
          25: 'Back edge lowers our low-link',
          27: 'Unvisited — recurse',
          28: 'Absorb the child low-link',
          29: 'Child cannot reach above u: the edge is a bridge',
          30: 'Record the bridge',
          32: 'Every component root in this group',
          33: 'Skip roots an earlier DFS already covered',
          34: 'Start a DFS from each unvisited root',
          35: 'Return the bridge edge indices',
          37: 'Edge indices sorted by weight',
          38: 'Result buckets',
          40: 'Sweep the sorted edges in equal-weight blocks',
          41: 'j walks to the end of the current weight block',
          42: 'Same weight — keep extending',
          44: 'Drop edges whose endpoints are already merged',
          45: 'Bridges of the contracted graph are the critical ones',
          46: 'Bucket each candidate',
          47: 'Bridge -> critical, otherwise pseudo-critical',
          48: 'Now merge the entire group into the DSU',
          50: 'Advance to the next weight block',
          51: 'Return both index lists',
        },
        javascript: {
          1: 'Define function with vertex count and weighted edges',
          2: 'One Union-Find that survives the whole sweep',
