...
export const medianTwoSortedArrays: Algorithm = {
  ...
  lineExplanations: {
    python: {
      ...
      2: 'Assign arrays to A and B',
      3: 'Compute total length of both arrays',
      4: 'Compute half of total for partition size',
      6: 'Ensure A is the shorter array for efficiency',
      7: 'Swap A and B if A is longer',
      9: 'Init binary search bounds on A',
      11: 'Binary search for correct partition',
      12: 'Partition index for A',
      13: 'Partition index for B (derived from i)',
      15: 'Left boundary of A partition (or -inf)',
      16: 'Right boundary of A partition (or +inf)',
      17: 'Left boundary of B partition (or -inf)',
      18: 'Right boundary of B partition (or +inf)',
      20: 'Check if partition is valid',
      21: 'If total is odd, median is min of rights',
      22: 'Return the smaller right-side value',
      23: 'Even total: average of max-left and min-right',
      24: 'A left too large, move partition left',
      25: 'Decrease right bound',
      27: 'A left too small, move partition right',
    },
    javascript: {
      1: 'Define function taking two sorted arrays',
      2: 'Assign arrays to A and B',
      ...
      6: 'Ensure A is the shorter array for efficiency',
      7: 'Swap A and B if A is longer',
      10: 'Init binary search bounds on A',
      12: 'Binary search for correct partition',
      13: 'Partition index for A',
      14: 'Partition index for B (derived from i)',
      16: 'Left boundary of A partition (or -Infinity)',
      17: 'Right boundary of A partition (or Infinity)',
      18: 'Left boundary of B partition (or -Infinity)',
      19: 'Right boundary of B partition (or Infinity)',
      21: 'Check if partition is valid',
      22: 'If total is odd, median is min of rights',
      23: 'Return the smaller right-side value',
      25: 'Even: average of max-left and min-right',
      26: 'Return the median value',
      27: 'A left too large, move partition left',
      28: 'Decrease right bound',
      30: 'A left too small, move partition right',
    },
    java: {
      ...
      4: 'Compute half of total for partition size',
      6: 'Ensure A is the shorter array for efficiency',
      7: 'Temporary holder for swap',
      8: 'Swap A and B',
      9: 'Complete the swap',
      12: 'Init binary search bounds on A',
      14: 'Binary search for correct partition',
      15: 'Partition index for A avoiding overflow',
      16: 'Partition index for B (derived from i)',
      18: 'Left boundary of A partition (or MIN_VALUE)',
      19: 'Right boundary of A partition (or MAX_VALUE)',
      20: 'Left boundary of B partition (or MIN_VALUE)',
      21: 'Right boundary of B partition (or MAX_VALUE)',
      23: 'Check if partition is valid',
      24: 'If total is odd, median is min of rights',
      25: 'Return the smaller right-side value',
      27: 'Even: average of max-left and min-right',
      28: 'Return the median as double',
      29: 'A left too large, move partition left',
      30: 'Decrease right bound',
      32: 'A left too small, move partition right',
      35: 'Fallback return (should not reach here)',
    },
  },
};
