...
export const addTwoNumbers: Algorithm = {
  ...
  lineExplanations: {
    python: {
      ...
      2: 'Create dummy node to simplify result list building',
      3: 'Set current pointer to dummy node',
      4: 'Initialize carry to zero',
      5: 'Loop while either list has nodes or carry remains',
      6: 'Get l1 digit value, or 0 if l1 is exhausted',
      7: 'Get l2 digit value, or 0 if l2 is exhausted',
      8: 'Compute sum of both digits plus carry',
      9: 'Update carry for next iteration (tens digit)',
      10: 'Append new node with ones digit to result',
      11: 'Advance current pointer to new node',
      12: 'Move l1 to next node if available',
      13: 'Move l2 to next node if available',
      14: 'Return result list starting after dummy',
    },
    javascript: {
      1: 'Define function taking two linked list heads',
      2: 'Create dummy node to simplify result list building',
      ...
      4: 'Initialize carry to zero',
      5: 'Loop while either list has nodes or carry remains',
      6: 'Get l1 digit value, or 0 if l1 is null',
      7: 'Get l2 digit value, or 0 if l2 is null',
      8: 'Compute sum of both digits plus carry',
      9: 'Update carry for next iteration (tens digit)',
      10: 'Append new node with ones digit to result',
      11: 'Advance current pointer to new node',
      12: 'Move l1 to next node if available',
      13: 'Move l2 to next node if available',
      15: 'Return result list starting after dummy',
    },
    java: {
      1: 'Define method taking two linked list heads',
      2: 'Create dummy node to simplify result list building',
      3: 'Set current pointer to dummy node',
      4: 'Initialize carry to zero',
      6: 'Loop while either list has nodes or carry remains',
      7: 'Get l1 digit value, or 0 if l1 is null',
      8: 'Get l2 digit value, or 0 if l2 is null',
      10: 'Compute sum of both digits plus carry',
      11: 'Update carry for next iteration (tens digit)',
      12: 'Keep only the ones digit of the sum',
      13: 'Append new node with digit to result list',
      15: 'Advance current pointer to new node',
      16: 'Move l1 to next node if available',
      17: 'Move l2 to next node if available',
      20: 'Return result list starting after dummy',
    },
  },
};
