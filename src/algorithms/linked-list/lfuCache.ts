...
export const lfuCache: Algorithm = {
  ...
  lineExplanations: {
    python: {
      ...
      6: 'use count -> ordered keys with that count (LRU first)',
      7: 'Smallest use count currently present — the eviction pointer',
      9: 'Helper: record one more use of a key',
      10: 'Its current count',
      11: 'Remove it from that bucket',
      12: 'Did that empty the bucket?',
      13: 'Drop the empty bucket',
      14: 'If it was the minimum bucket...',
      15: '...the minimum shifts up by one (the only way min_count ever rises)',
      16: 'Record the new count',
      17: 'Append to the next bucket — appending keeps LRU order inside it',
      19: 'Read a key',
      20: 'Not cached?',
      21: 'Return -1 — a miss records nothing',
      22: 'Hit: count this use',
      23: 'Return the stored value',
      25: 'Write a key',
      26: 'Zero-capacity cache stores nothing',
      27: 'Nothing to do',
      28: 'Key already present?',
      29: 'Overwrite the value',
      30: 'A write counts as a use',
      31: 'Done — size did not change',
      32: 'New key and the cache is full',
      33: 'Pop the FRONT of the min bucket: least used, and least recent among those',
      34: 'Remove it from the value map',
      35: 'Remove its count',
      36: 'Store the new value',
      37: 'A brand-new key has been used once',
      38: 'Put it in bucket 1',
      39: 'Reset min_count to 1 — a fresh key is always the least used',
    },
    javascript: {
      1: 'Define the LFU cache class',
      2: 'Constructor takes the capacity',
