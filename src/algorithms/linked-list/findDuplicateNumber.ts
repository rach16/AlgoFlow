...
export const findDuplicateNumber: Algorithm = {
  ...
  lineExplanations: {
    python: {
      ...
      3: 'Init slow pointer at nums[0]',
      4: 'Init fast pointer at nums[0]',
      5: 'Loop indefinitely until pointers meet',
      6: 'Move slow one step through linked list',
      7: 'Move fast two steps through linked list',
      8: 'If pointers meet, cycle detected',
      9: 'Exit the loop',
      11: 'Start second pointer from nums[0]',
      12: 'Move both one step until they meet',
      13: 'Advance slow one step',
      14: 'Advance slow2 one step',
      15: 'Meeting point is the duplicate number',
    },
    javascript: {
      1: 'Define function taking nums array',
      3: 'Init slow pointer at nums[0]',
      4: 'Init fast pointer at nums[0]',
      5: 'Start do-while loop for phase 1',
      6: 'Move slow one step through linked list',
      7: 'Move fast two steps through linked list',
      8: 'Continue until pointers meet',
      10: 'Start second pointer from nums[0]',
      11: 'Move both one step until they meet',
      12: 'Advance slow one step',
      13: 'Advance slow2 one step',
      15: 'Meeting point is the duplicate number',
    },
    java: {
      ...
      7: 'Move fast two steps through linked list',
      8: 'Continue until pointers meet',
      11: 'Reset slow to nums[0] for phase 2',
      12: 'Move both one step until they meet',
      13: 'Advance slow one step',
      14: 'Advance fast one step',
      17: 'Meeting point is the duplicate number',
    },
  },
};
