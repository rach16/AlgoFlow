...
private static TreeNode build(int[] preorder, int left, int right) {
  ...
  lineExplanations: {
    ...
    java: {
      ...
      13: 'Define recursive build with inorder range',
      14: 'Base case: invalid range returns null',
      15: 'Get root value, advance preorder index',
      16: 'Create tree node with root value',
      17: 'Find root position in inorder array',
      18: 'Recursively build left subtree',
      19: 'Recursively build right subtree',
      20: 'Return constructed node',
    },
  },
};
