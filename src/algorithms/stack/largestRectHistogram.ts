...
export const largestRectHistogram: Algorithm = {
  ...
  lineExplanations: {
    python: {
      ...
      2: 'Initialize max area to zero',
      3: 'Initialize stack for (index, height) pairs',
      5: 'Iterate through each bar with index',
      6: 'Track start index for extending backwards',
      7: 'While stack top is taller than current bar',
      8: 'Pop the taller bar from stack',
      9: 'Update max area with popped bar rectangle',
      10: 'Extend start back to popped bar index',
      11: 'Push current bar with extended start index',
      13: 'Process remaining bars extending to end',
      14: 'Update max area for bars reaching the end',
      16: 'Return the largest rectangle area',
    },
    javascript: {
      1: 'Define function taking heights array',
      2: 'Initialize max area to zero',
      3: 'Initialize stack for [index, height] pairs',
      5: 'Iterate through each bar index',
      6: 'Track start index for extending backwards',
      7: 'While stack top is taller than current bar',
      8: 'Pop the taller bar from stack',
      9: 'Update max area with popped bar rectangle',
      10: 'Extend start back to popped bar index',
      12: 'Push current bar with extended start index',
      15: 'Process remaining bars extending to end',
      16: 'Update max area for bars reaching the end',
      19: 'Return the largest rectangle area',
    },
    java: {
      ...
      7: 'While stack top is taller than current bar',
      8: 'Pop the taller bar from stack',
      9: 'Extract popped index',
      10: 'Extract popped height',
      11: 'Update max area with popped bar rectangle',
      12: 'Extend start back to popped bar index',
      14: 'Push current bar with extended start index',
      17: 'Process remaining bars in stack',
      18: 'Pop remaining bar from stack',
      19: 'Extract index of remaining bar',
      20: 'Extract height of remaining bar',
      21: 'Update max area for bars reaching the end',
      24: 'Return the largest rectangle area',
    },
  },
};
