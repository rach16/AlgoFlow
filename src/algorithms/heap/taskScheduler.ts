...
def leastInterval(tasks, n):
  ...
  lineExplanations: {
    ...
    javascript: {
      ...
      18: 'Check if cooldown task is ready',
      19: 'Move ready task back to heap',
      22: 'Return total time units needed',
    },
    java: {
      ...
      6: 'Create max-heap sorted by count descending',
      7: 'Add all task counts to heap',
      9: 'Track elapsed time units',
      10: 'Cooldown queue: [count, availableTime]',
      12: 'Process until all tasks complete',
      13: 'Increment time each iteration',
      14: 'If tasks available in heap',
      15: 'Pop most frequent task count',
      16: 'If remaining, add to cooldown',
      17: 'Queue with count and available time',
      20: 'Check if cooldown task is ready',
      21: 'Move ready task back to heap',
      24: 'Return total time units needed',
    },
  },
};
