...
class MedianFinder:
  ...
  lineExplanations: {
    python: {
      ...
      18: 'Comment: balance heap sizes',
      19: 'If small has more than 1 extra element',
      20: 'Move top of small to large',
      21: 'Push to large heap',
      22: 'If large is bigger than small',
      23: 'Move top of large to small',
      24: 'Push negated value to small heap',
      26: 'Find current median',
      27: 'Odd total: median is top of small',
      28: 'Return negated top of max-heap',
      29: 'Even total: average of both tops',
    },
    javascript: {
      1: 'Define the MedianFinder class',
      2: 'Initialize MedianFinder instance',
