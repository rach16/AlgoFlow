...
export const coinChangeII: Algorithm = {
  ...
  lineExplanations: {
    python: {
      ...
      2: 'Create 2D DP table with (coins+1) rows',
      3: 'Continuation of table initialization',
      4: 'Base case: one way to make amount 0',
      5: 'Set dp[i][0] = 1 for each coin row',
      6: 'Iterate over each coin',
      7: 'Iterate over each sub-amount',
      8: 'Start with ways excluding current coin',
      9: 'If coin value fits in sub-amount',
      10: 'Add ways using current coin (unbounded)',
      11: 'Return total combinations for full amount',
    },
    javascript: {
      1: 'Define function taking amount and coins array',
      2: 'Create 2D DP table with (coins+1) rows',
      3: 'Continuation of array initialization',
      4: 'Continuation of fill(0)',
      5: 'Base case: one way to make amount 0',
      6: 'Set dp[i][0] = 1 for each coin row',
      7: 'Iterate over each coin',
      8: 'Iterate over each sub-amount',
      9: 'Start with ways excluding current coin',
      10: 'If coin value fits in sub-amount',
      11: 'Add ways using current coin (unbounded)',
      14: 'Return total combinations for full amount',
    },
    java: {
      1: 'Define method taking amount and coins array',
      2: 'Create 2D DP table initialized to 0',
      3: 'Base case: one way to make amount 0',
      4: 'Set dp[i][0] = 1 for each coin row',
      6: 'Iterate over each coin',
      7: 'Iterate over each sub-amount',
      8: 'Start with ways excluding current coin',
      9: 'If coin value fits in sub-amount',
