...
private int dfs(int[][] matrix, int r, int c, int[][] memo) {
  ...
  lineExplanations: {
    ...
    java: {
      ...
      12: 'Define DFS helper method',
      13: 'Return cached result if already computed',
      14: 'Start with path length 1 (the cell itself)',
      15: 'Define four movement directions',
      16: 'Try each direction',
      17: 'Compute neighbor coordinates',
      18: 'Check bounds and increasing value',
      19: 'Continuation of bounds check',
      20: 'Update max path via recursive DFS',
      23: 'Cache result for cell (r, c)',
      24: 'Return the longest path from this cell',
    },
  },
};
