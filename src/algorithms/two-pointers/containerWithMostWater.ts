...
export const containerWithMostWater: Algorithm = {
  ...
  lineExplanations: {
    python: {
      ...
      6: 'Compute area: width * shorter height',
      7: 'Update result if current area is larger',
      9: 'If left height is shorter',
      10: 'Move left pointer right to try taller line',
      11: 'If right height is shorter',
    ...
    javascript: {
      ...
      4: 'Track maximum area found so far',
      6: 'Loop while pointers haven\'t crossed',
      7: 'Compute area: width * shorter height',
      8: 'Update result if current area is larger',
      10: 'If left height is shorter',
      11: 'Move left pointer right to try taller line',
      12: 'If right height is shorter',
      13: 'Move right pointer left to try taller line',
      14: 'Heights are equal',
      15: 'Move left inward',
      16: 'Move right inward',
      20: 'Return the maximum area found',
    },
    java: {
      1: 'Define function taking height array',
      2: 'Init left pointer at start',
