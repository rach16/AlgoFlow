...
export const threeSum: Algorithm = {
  ...
  lineExplanations: {
    python: {
      ...
      2: 'Sort array so we can use two pointers',
      3: 'Init empty result list for triplets',
      5: 'Iterate over each element as first number',
      6: 'If first number > 0, no valid triplet possible',
      7: 'Break early since array is sorted',
      9: 'Skip duplicate values for first number',
      10: 'Continue to next iteration',
      12: 'Set left and right pointers after i',
      13: 'Search for pairs while pointers haven\'t met',
      14: 'Compute sum of the three elements',
      16: 'If sum too large, decrease right pointer',
      17: 'Move right pointer left',
      18: 'If sum too small, increase left pointer',
      19: 'Move left pointer right',
      21: 'Append valid triplet to results',
      22: 'Advance left pointer past found value',
      23: 'Skip duplicate left values to avoid repeats',
      24: 'Keep advancing past duplicates',
      25: 'Return all unique triplets found',
    },
    javascript: {
      1: 'Define function taking nums array',
      2: 'Sort array for two-pointer approach',
      3: 'Init empty result array for triplets',
      5: 'Iterate each element as first number',
      6: 'Break if first number > 0 (no valid sum)',
      8: 'Skip duplicate values for first number',
      10: 'Set left pointer right after i',
      11: 'Set right pointer at end of array',
      12: 'Search for pairs while pointers haven\'t met',
      13: 'Compute sum of the three elements',
      15: 'If sum too large',
      16: 'Decrease right pointer',
      17: 'If sum too small',
      18: 'Increase left pointer',
      20: 'Push valid triplet to results',
      21: 'Advance left pointer past found value',
      22: 'Skip duplicate left values to avoid repeats',
      23: 'Keep advancing past duplicates',
      28: 'Return all unique triplets found',
    },
    java: {
      1: 'Define function taking nums array',
      2: 'Sort array for two-pointer approach',
      ...
      17: 'If sum too small',
      18: 'Increase left pointer',
      20: 'Add valid triplet to results',
      21: 'Advance left pointer past found value',
      22: 'Skip duplicate left values to avoid repeats',
      23: 'Keep advancing past duplicates',
      28: 'Return all unique triplets found',
