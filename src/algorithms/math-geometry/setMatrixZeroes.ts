...
export const setMatrixZeroes: Algorithm = {
  ...
  lineExplanations: {
    ...
    java: {
      ...
      14: 'Zero out inner cells based on markers',
      15: 'Iterate over columns',
      16: 'If row or column marker is 0',
      17: 'Set cell to 0',
      22: 'If top-left is 0, zero first column',
      23: 'Set each cell in first column to 0',
      25: 'If first row had zero, zero it out',
      26: 'Set each cell in first row to 0',
    },
  },
};
